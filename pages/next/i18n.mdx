...
```mjs filename="next.config.mjs" {3} copy
...
```
```js filename="next-i18next.config.js" {3} copy
...
```tsx filename="Index Page Example" {3} copy
...
```json filename="common.json Example for I18N" {3} copy
{
    "home": "home",
